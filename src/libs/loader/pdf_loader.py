...
- Optional OCR for extracting text from embedded images
"""
...
class PdfLoader(BaseLoader):
    ...
    Configuration:
        ...
        enable_ocr: Run OCR on extracted images to recover embedded text
            (default: False, requires ``pip install easyocr``)

    Graceful Degradation:
        If image extraction or OCR fails, logs warning and continues.
    """
    ...
    def __init__(
        ...
        Args:
            ...
            enable_ocr: Whether to OCR extracted images for embedded text.
        """
        ...
        self._ocr_reader: Any = None  # lazy-initialised EasyOCR reader
            ...
            for page_num in range(len(doc)):
                ...
                for img_index, img_info in enumerate(image_list):
                    try:
                        ...
                        # OCR embedded text from image (optional)
                        ocr_text = ""
                        if self.enable_ocr:
                        ...
                        if ocr_text:
                            image_metadata["ocr_text"] = ocr_text
    ...
    def _init_ocr(self) -> None:
        """Lazy-initialise the EasyOCR reader (Chinese + English)."""
        ...
        logger.info("Initializing EasyOCR reader (ch_sim + en)...")
    ...
    def _ocr_image(self, image_path: Path) -> str:
        ...
        try:
            self._init_ocr()
            results = self._ocr_reader.readtext(str(image_path), detail=0)
